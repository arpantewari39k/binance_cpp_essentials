...
end_seq = None
print("\n-----> Downloading data...\n")
trades =['BTCUSDT','ETHUSDT','BUSDUSDT','SOLUSDT','FILUSDT','VGXUSDT','SHIBUSDT','BNBUSDT','OPUSDT','FILUSDT','DOGEUSDT','FTMUSDT','LDOUSDT','TRUUSDT','CFXUSDT']
list_di=[]
print(trades)
...
df.to_csv("means_std.csv",index=False)
print(df)